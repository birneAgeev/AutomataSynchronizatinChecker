...
typedef struct __mpz_struct MP_INT;
typedef struct __mpz_struct mpz_t[1];

typedef struct
{
	struct __mpz_struct _mp_num;
	struct __mpz_struct _mp_den;
} __mpq_struct;
...
typedef __gmp_const struct __mpz_struct *mpz_srcptr;
typedef struct __mpz_struct *mpz_ptr;
