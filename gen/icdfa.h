 ...
 */
static void icdfaSetFinals(icdfa_t icdfa, zset_t finals)
{
 ...
 */
static void icdfaUpdateAutomaton(struct icdfa* icdfa, state_t *_new)
{
 ...
 */
static void icdfaSetElem(icdfa_t icdfa, int i, state_t st)
{
  ICDFA(icdfa)[i] = st;
  ICDFA_MINIMAL(icdfa) = MAYBE;
  ICDFA_ACYCLIC(icdfa) = MAYBE;
 ...
 */
static state_t icdfaGetElem(icdfa_t icdfa, int i)
{
 ...
 */
static state_t icdfaEqual(icdfa_t i0, icdfa_t i1)
{
